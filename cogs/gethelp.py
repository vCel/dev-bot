...
class MainCommands(commands.Cog):
    ...
    async def help(self, ctx):
        embed = discord.Embed(description="To use me, please use the ';' prefix followed by any of the commands listed below.\n"
                                          ...
                                          "ss :: Looks up information regarding the mobile game 'Soccer Spirits' (Teamwork, Unique Stones, DR).\n"
                                          "al :: Looks up information regarding the mobile game 'Azur Lane' (Ships, Skins).\n```",
                              color=0x39fc03)
